              ...
              children: [
                ...
                buildActionButton(
                  ...
                  onPressed: () {
                    ...
                    // Check if this is a recurring event with a seriesId
                    if (event is ExtendedCalendarEventData && 
                      ...
                      _showDeleteOptionsDialog(
                        context, 
                        event, 
                        (context, singleEvent) => onDeleteEvent(context, singleEvent), 
                        onDeleteSeries
                      );
                    } else {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(context);
              onDeleteEvent(context, event); // Delete only this instance
            },
            child: const Text('Only this event'),
          ),
          TextButton(
